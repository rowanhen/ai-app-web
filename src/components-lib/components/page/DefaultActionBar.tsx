...
import { toggleDebugGrid } from "@components-lib/DebugGrid";
import { useHotkeys } from "@modules-lib/hotkeys";

import ActionBar from "@components-lib/ActionBar";
            ...
            items: [
              {
                ...
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-chicago-mono"),
              },
              {
                icon: "⊹",
              ...
              },
              {
                ...
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-code-new-roman-mono"),
              },
              {
                icon: "⊹",
              ...
              },
              {
                ...
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-glasstty-vt220"),
              },
              {
                icon: "⊹",
              ...
              },
              {
                ...
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-intel-one-mono"),
              },
              {
                icon: "⊹",
              ...
              },
              {
                ...
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-julia-mono"),
              },
              {
                icon: "⊹",
                children: "Kommuna Mono™ Trial [type.tmpstate.net]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-kommuna-mono"),
              },
              {
                icon: "⊹",
                children: "Monaspace Argon Variable [OFL]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-monaspace-argon-mono"),
              },
              {
                icon: "⊹",
                children: "Monaspace Krypton Variable [OFL]",
                onClick: () =>
                  Utilities.onHandleFontChange(
                    "font-use-monaspace-krypton-mono"
                  ),
              },
              {
                icon: "⊹",
                ...
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-monaspace-neon-mono"),
              },
              {
                icon: "⊹",
                children: "Monaspace Radon Variable [OFL]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-monaspace-radon-mono"),
              },
              {
                icon: "⊹",
                children: "Monaspace Xenon Variable [OFL]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-monaspace-xenon-mono"),
              },
              {
                icon: "⊹",
                children: "M1 Plus Mono [OFL]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-m1-plus-mono"),
              },
              {
                icon: "⊹",
                children: "Panama Mono™ Trial [type.tmpstate.net]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-panama-mono"),
              },
              {
                icon: "⊹",
                children:
                  "Web437 DOS/V re. ANK16 [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-web437-dos-v-ank16"),
              },
              {
                icon: "⊹",
                children:
                  "Web437 DOS/V re. ANK19 [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-web437-dos-v-ank19"),
              },
              {
                icon: "⊹",
                children:
                  "Web437 DOS/V re. ANK24 [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-web437-dos-v-ank24"),
              },
              {
                icon: "⊹",
                children:
                  "Web437 DOS/V re. ANK30 [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-web437-dos-v-ank30"),
              },
              {
                icon: "⊹",
                children:
                  "Web437 Nix8810 M16 [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-web437-nix8810-m16"),
              },
              {
                icon: "⊹",
                children:
                  "Web437 Pheonix EGA 8X8 2Y [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange(
                    "font-use-web437-pheonix-ega-8x8-2y"
                  ),
              },
              {
                icon: "⊹",
                children:
                  "Web437 Sanyo MB C775 2Y [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange(
                    "font-use-web437-sanyo-mb-c775-2y"
                  ),
              },
              {
                icon: "⊹",
                children:
                  "WebPlus AST PremiumExec [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange(
                    "font-use-webplus-ast-premiumexec"
                  ),
              },
              {
                icon: "⊹",
                children:
                  "WebPlus IBM BIOS [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-web-plus-ibm-bios"),
              },
              {
                icon: "⊹",
                children:
                  "WebPlus IBM VGA 8X16 [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange(
                    "font-use-web-plus-ibm-vga-8x16"
                  ),
              },
              {
                icon: "⊹",
                children:
                  "WebPlus ToshibaTxL1-8x16 [int10h.org] [VileR] [CC BY-SA 4.0]",
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-toshiba-tx-l1-8x16"),
              },
              {
                icon: "⊹",
              ...
              },
              {
                ...
                onClick: () =>
                  Utilities.onHandleFontChange("font-use-ubuntu-mono"),
              },
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                children: "Blue",
                onClick: () =>
                  Utilities.onHandleAppearanceModeChange("tint-blue"),
              },
              {
                icon: "⊹",
                children: "Green",
                onClick: () =>
                  Utilities.onHandleAppearanceModeChange("tint-green"),
              },
              {
                icon: "⊹",
                children: "Orange",
                onClick: () =>
                  Utilities.onHandleAppearanceModeChange("tint-orange"),
              },
              {
                icon: "⊹",
                children: "Purple",
                onClick: () =>
                  Utilities.onHandleAppearanceModeChange("tint-purple"),
              },
              {
                icon: "⊹",
                children: "Red",
                onClick: () =>
                  Utilities.onHandleAppearanceModeChange("tint-red"),
              },
              {
                icon: "⊹",
                children: "Yellow",
                onClick: () =>
                  Utilities.onHandleAppearanceModeChange("tint-yellow"),
              },
              {
                icon: "⊹",
                children: "Pink",
                onClick: () =>
                  Utilities.onHandleAppearanceModeChange("tint-pink"),
              },
            ],
          },
          {
