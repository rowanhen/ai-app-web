import styles from "@components-lib/HoverComponentTrigger.module.scss";

import * as Position from "@common-lib/position";
import * as React from "react";

import OutsideElementEvent from "@components-lib/detectors/OutsideElementEvent";
...
function HoverComponentTrigger({
  children,
  text,
  component,
}: HoverComponentTriggerProps) {
